...
# --- Config ---
st.set_page_config(page_title="Performance Prediction", layout="wide")
st.title("Page 4: Performance Prediction")
...
if "shared_df" in st.session_state:
    ...
    with st.expander("Train Model", expanded=False):
        ...
        uploaded_file = df_uploaded.copy()
    ...
    st.warning("⚠️ Please upload an Excel file on the Upload Data page to use Performance Prediction.")